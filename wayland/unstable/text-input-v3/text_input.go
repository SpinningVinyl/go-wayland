...
// XML file : https://gitlab.freedesktop.org/wayland/wayland-protocols/-/raw/1.49/unstable/text-input/text-input-unstable-v3.xml
//
...
type TextInput struct {
	...
	actionHandler                TextInputActionHandlerFunc
	languageHandler              TextInputLanguageHandlerFunc
	preeditHintHandler           TextInputPreeditHintHandlerFunc
}
...
func (i *TextInput) SetAvailableActions(availableActions []byte) error {
	const opcode = 8
	availableActionsLen := client.PaddedLen(len(availableActions))
	_reqBufLen := 8 + (4 + availableActionsLen)
	_reqBuf := make([]byte, _reqBufLen)
	l := 0
	client.PutUint32(_reqBuf[l:4], i.ID())
	l += 4
	client.PutUint32(_reqBuf[l:l+4], uint32(_reqBufLen<<16|opcode&0x0000ffff))
	l += 4
	client.PutArray(_reqBuf[l:l+(4+availableActionsLen)], availableActions)
	l += availableActionsLen
	err := i.Context().WriteMsg(_reqBuf, nil)
	return err
}
...
const (
	...
	// TextInputContentHintOnScreenInputProvided : an on-screen way to fill in the input is already provided by the client
	TextInputContentHintOnScreenInputProvided TextInputContentHint = 0x400
	// TextInputContentHintNoEmoji : prefer not offering emoji support
	TextInputContentHintNoEmoji TextInputContentHint = 0x800
	// TextInputContentHintPreeditShown : the text input will display preedit text in place
	TextInputContentHintPreeditShown TextInputContentHint = 0x1000
)
...
func (e TextInputContentHint) Name() string {
	...
	case TextInputContentHintMultiline:
		return "multiline"
	case TextInputContentHintOnScreenInputProvided:
		return "on_screen_input_provided"
	case TextInputContentHintNoEmoji:
		return "no_emoji"
	case TextInputContentHintPreeditShown:
...
type TextInputError uint32

// TextInputError :
const (
	// TextInputErrorInvalidAction : an invalid or duplicate action was specified
	TextInputErrorInvalidAction TextInputError = 0
)

func (e TextInputError) Name() string {
	switch e {
	case TextInputErrorInvalidAction:
...
func (e TextInputError) Value() string {
	switch e {
	case TextInputErrorInvalidAction:
		return "0"
	default:
...
func (e TextInputError) String() string {
	return e.Name() + "=" + e.Value()
}

type TextInputAction uint32
...
const (
	// TextInputActionNone : no action
	TextInputActionNone TextInputAction = 0
	// TextInputActionSubmit : the action is submitted
	TextInputActionSubmit TextInputAction = 1
)

func (e TextInputAction) Name() string {
	switch e {
	case TextInputActionNone:
		return "none"
	case TextInputActionSubmit:
		return "submit"
	default:
		return ""
	}
...
func (e TextInputAction) Value() string {
	switch e {
	case TextInputActionNone:
		return "0"
	case TextInputActionSubmit:
...
func (e TextInputAction) String() string {
	return e.Name() + "=" + e.Value()
}

type TextInputPreeditHint uint32

// TextInputPreeditHint : preedit style hint
//
// Style hints for the preedit string.
const (
	// TextInputPreeditHintWhole : simple pre-edit text style, typically underlined
	TextInputPreeditHintWhole TextInputPreeditHint = 1
	// TextInputPreeditHintSelection : hint for a selected piece of text, e.g.
	TextInputPreeditHintSelection TextInputPreeditHint = 2
	// TextInputPreeditHintPrediction : predicted text, not typed by the user
	TextInputPreeditHintPrediction TextInputPreeditHint = 3
	// TextInputPreeditHintPrefix : prefixed text not being currently edited, e.g.
	TextInputPreeditHintPrefix TextInputPreeditHint = 4
	// TextInputPreeditHintSuffix : suffixed text not being currently edited, e.g.
	TextInputPreeditHintSuffix TextInputPreeditHint = 5
	// TextInputPreeditHintSpellingError : spelling error
	TextInputPreeditHintSpellingError TextInputPreeditHint = 6
	// TextInputPreeditHintComposeError : wrong composition, e.g.
	TextInputPreeditHintComposeError TextInputPreeditHint = 7
)

func (e TextInputPreeditHint) Name() string {
	switch e {
	case TextInputPreeditHintWhole:
		return "whole"
	case TextInputPreeditHintSelection:
		return "selection"
	case TextInputPreeditHintPrediction:
		return "prediction"
	case TextInputPreeditHintPrefix:
		return "prefix"
	case TextInputPreeditHintSuffix:
		return "suffix"
	case TextInputPreeditHintSpellingError:
		return "spelling_error"
	case TextInputPreeditHintComposeError:
...
func (e TextInputPreeditHint) Value() string {
	switch e {
	case TextInputPreeditHintWhole:
		return "1"
	case TextInputPreeditHintSelection:
...
func (e TextInputPreeditHint) String() string {
	return e.Name() + "=" + e.Value()
}
...
// TextInputActionEvent : action performed
//
...
type TextInputActionEvent struct {
	Action uint32
	Serial uint32
}
type TextInputActionHandlerFunc func(TextInputActionEvent)

// SetActionHandler : sets handler for TextInputActionEvent
func (i *TextInput) SetActionHandler(f TextInputActionHandlerFunc) {
	i.actionHandler = f
}

// TextInputLanguageEvent : notify of language selection
//
...
// TextInputPreeditHintEvent : pre-edit
//
...
type TextInputPreeditHintEvent struct {
	Start uint32
	End   uint32
	Hint  uint32
}
type TextInputPreeditHintHandlerFunc func(TextInputPreeditHintEvent)

// SetPreeditHintHandler : sets handler for TextInputPreeditHintEvent
func (i *TextInput) SetPreeditHintHandler(f TextInputPreeditHintHandlerFunc) {
	i.preeditHintHandler = f
}
...
func (i *TextInput) Dispatch(opcode uint32, fd int, data []byte) {
	...
	case 6:
		...
		var e TextInputActionEvent
		l := 0
		e.Action = client.Uint32(data[l : l+4])
		l += 4
		e.Serial = client.Uint32(data[l : l+4])
		l += 4
	...
	case 7:
		...
		i.languageHandler(e)
	case 8:
		if i.preeditHintHandler == nil {
			return
		}
		var e TextInputPreeditHintEvent
		l := 0
		e.Start = client.Uint32(data[l : l+4])
		l += 4
		e.End = client.Uint32(data[l : l+4])
		l += 4
		e.Hint = client.Uint32(data[l : l+4])
		l += 4

		i.preeditHintHandler(e)
	}
}
